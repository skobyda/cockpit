...
LIBVIRT_DBUS_PROVIDER = {
    ...
    GET_API_DATA({ connectionName, libvirtServiceName }) {
        ...
        unknownConnectionName(connectionName => initResource(connectionName, "ListInterfaces", updateOrAddInterface, flags));
        unknownConnectionName(connectionName  => {
            console.log("CODE REACHED THIS PLACE");
            return initResource(connectionName, "ListNodeDevices", updateOrAddNodeDevice, 0);
        });
        unknownConnectionName(connectionName => initResource(connectionName, "ListNetworks", updateOrAddNetwork, 0));
        unknownConnectionName(connectionName => initResource(connectionName, "ListStoragePools", updateOrAddStoragePool, 0));
        unknownConnectionName(connectionName => initResource(connectionName, "ListDomains", updateOrAddVm, 0));
...
function initResource(connectionName, method, updateOrAddMethod, flags) {
    console.log("CODE REACHED ANOTHER PLACE");
