...
export class NetworkOverviewTab extends React.Component {
    ...
    onAutostartChanged() {
        ...
        dispatch(changeNetworkAutostart({ network, autostart }))
                .then(() => {
                    dispatch(getNetwork({ connectionName: network.connectionName, id: network.id, name: network.name }));
                });
    }
