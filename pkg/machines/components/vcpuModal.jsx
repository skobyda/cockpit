            ...
            <div className="vcpu-modal-grid">
                <div className="ct-form">
                    ...
                    <div controlid="vcpu-count" role="group">
                        ...
                        <div className="info-circle">
                            <Tooltip content={_("Fewer than the maximum number of virtual CPUs should be enabled.")}>
                                <InfoAltIcon />
                            </Tooltip>
                        </div>
                    </div>
                    ...
                    <div controlid="vcpu-maximum" role="group">
                        ...
                        <div className="info-circle">
                            <Tooltip content={cockpit.format(
                ...
                <div className="ct-form">
                    ...
                    <div controlid="sockets" role="group">
                        ...
                        <div className="info-circle">
                            <Tooltip content={_("Preferred number of sockets to expose to the guest.")}>
                                <InfoAltIcon />
                            </Tooltip>
                        </div>
                    </div>
